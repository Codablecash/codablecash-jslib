...
export class RevokeMissedTicket extends AbstractRevokeTransaction {
	...
	public getTicketVotedUtxoReference() : TicketVotedUtxoReference{
		...
		throw new NullPointerException("RevokeMissedTicket.getTicketVotedUtxoReference()");
	}
    ...
    public binarySize() : number {
        ...
        throw new NullPointerException("RevokeMissedTicket.binarySize()");
    }
    ...
    public toBinary(out : ByteBuffer) : void {
        ...
        throw new NullPointerException("RevokeMissedTicket.toBinary()");
    }
    ...
    public getUtxoReference(i : number) : AbstractUtxoReference {
        ...
        throw new NullPointerException("RevokeMissedTicket.getUtxoReference()");
    }
