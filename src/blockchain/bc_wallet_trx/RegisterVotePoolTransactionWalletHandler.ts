...
export class RegisterVotePoolTransactionWalletHandler extends AbstractWalletTransactionHandler {
    ...
    public createTransaction(
            source : NodeIdentifierSource, feeRate : BalanceUnit, addressDesc : AddressDescriptor, encoder : IWalletDataEncoder,
            context : ITransactionBuilderContext) : RegisterVotePoolTransaction {
        ...
        let nodeId = source.toNodeIdentifier();
        let trx = new RegisterVotePoolTransaction(nodeId, addressDesc);
    ...
    public collectUtxoRefs(trx : RegisterVotePoolTransaction, amount : BalanceUnit, feeRate : BalanceUnit, collector : IUtxoCollector,
            utxoFinder : ArrayUtxoFinder, musigProvidor : HdWalleMuSigSignerProvidor, encoder : IWalletDataEncoder) {
    ...
    public importTransaction(__trx : AbstractBlockchainTransaction) {
        let trx = <RegisterVotePoolTransaction>(__trx);
